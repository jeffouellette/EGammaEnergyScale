...
const static int minbias_trig_n_pp15 = 2;
const std::string minbias_trig_name_pp15 [minbias_trig_n_pp15] = {
  "HLT_mb_sptrk"
};

const static int max_minbias_trig_n = std::max (minbias_trig_n_PbPb18, std::max (minbias_trig_n_pp17, std::max (minbias_trig_n_pPb16, std::max (minbias_trig_n_PbPb15, minbias_trig_n_pp15))));
...
const static int electron_trig_n_pp15 = 1;
const std::string electron_trig_name_pp15 [electron_trig_n_pp15] = {
  "HLT_e15_lhloose_L1EM13VH"
};

const static int max_electron_trig_n = std::max (electron_trig_n_PbPb18, std::max (electron_trig_n_pp17, std::max (electron_trig_n_pPb16, std::max (electron_trig_n_PbPb15, electron_trig_n_pp15))));
...
const static int muon_trig_n_pp15 = 1;
const std::string muon_trig_name_pp15 [muon_trig_n_pp15] = {
  "HLT_mu14"
};

const static int max_muon_trig_n = std::max (muon_trig_n_PbPb18, std::max (muon_trig_n_pp17, std::max (muon_trig_n_pPb16, std::max (muon_trig_n_PbPb15, muon_trig_n_pp15))));
...
const static int photon_trig_n_pp15 = 1;
const std::string photon_trig_name_pp15 [photon_trig_n_pp15] = {
  "HLT_g30_loose"
};

const static int max_photon_trig_n = std::max (photon_trig_n_PbPb18, std::max (photon_trig_n_pp17, std::max (photon_trig_n_pPb16, std::max (photon_trig_n_PbPb15, photon_trig_n_pp15))));
...
const static int jet_trig_n_pp15 = 1;
const std::string jet_trig_name_pp15 [jet_trig_n_pp15] = {
  "HLT_j75_L1J20"
};
...
bool electron_lhmedium_hi[max_electron_n];
...
std::vector <std::vector <float>>* electron_pt_sys;
std::vector <std::vector <float>>* electron_eta_sys;
std::vector <std::vector <float>>* electron_phi_sys;
...
//std::vector <std::vector <float>> muon_pt_sys;
//std::vector <std::vector <float>> muon_eta_sys;
//std::vector <std::vector <float>> muon_phi_sys;
